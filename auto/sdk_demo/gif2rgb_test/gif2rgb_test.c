...
#define GIF_PATH "/tmp/gif2rgb_test/rainbow.gif"
#define RGB_PATH "/tmp/gif2rgb_test/rainbow-%d.rgb"
...
static void GIF2RGB(char *FileName, char *OutFileNamePattern)
{
    ...
    if (GifFile->SHeight == 0 || GifFile->SWidth == 0) {
        fprintf(stderr, "Image of width or height is 0\n");
        exit(EXIT_FAILURE);
    }
    ...
    do {
        ...
        switch (RecordType) {
            case IMAGE_DESC_RECORD_TYPE:
                ...
                printf("gif2rgb: Image %d at (%d, %d) [%dx%d]:     ",
