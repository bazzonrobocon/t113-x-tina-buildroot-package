...
int config_get_curfiledir(int section, char *obuf) {
    if (obuf == NULL) {
        CameraLogE("config_get_curfiledir obuf err");
        return -1;
    }
    CameraLogV("config_get_curfiledir");

    struct val_st val;
    char sectbuf[32];
    sprintf(sectbuf, "%s%d", SECTION_CAMERA_PREFIX, section);
    if (get_ini_value(sectbuf, CAMERA_KEY_DIR, &val) == -1) {
        CameraLogE("config_get_curfiledir get value err");
        return -2;
    } else {
        if (val.type == VALUE_TYPE_STR) {
            strcpy(obuf, val.val.str);
            CameraLogV("get a ini value ostr:%s", obuf);
        } else if (val.type == VALUE_TYPE_NUM) {
            CameraLogV("config_get_curfiledir value num:%d", val.val.num);
            return -3;
        } else {
            CameraLogV("config_get_curfiledir unknown:%d", val.type);
...
int config_get_camfileidx(int section) {
    ...
    if (val.type == VALUE_TYPE_NUM) {
        ret = val.val.num;
        CameraLogV("get a ini value num:%d", val.val.num);
    }
...
int config_get_startup(int section) {
    ...
    if (val.type == VALUE_TYPE_NUM) {
        ret = val.val.num;
        CameraLogV("config_get_startup value num:%d", val.val.num);
    }
    return ret;
}
...
int config_get_width(int section) {
    ...
    if (val.type == VALUE_TYPE_NUM) {
        ret = val.val.num;
        CameraLogV("config_get_width value num:%d", val.val.num);
    }
    return ret;
}
...
int config_get_heigth(int section) {
    ...
    if (val.type == VALUE_TYPE_NUM) {
        ret = val.val.num;
        CameraLogV("config_get_heigth value num:%d", val.val.num);
    }
    return ret;
}
...
int config_get_cyctime(int section) {
    ...
    if (val.type == VALUE_TYPE_NUM) {
        ret = val.val.num;
        CameraLogV("config_get_cyctime value num:%d", val.val.num);
    }
    return ret;
}
...
int config_get_tvout(int section) {
    ...
    if (val.type == VALUE_TYPE_NUM) {
        ret = val.val.num;
        CameraLogV("config_get_tvout value num:%d", val.val.num);
    }
    return ret;
}
...
int config_get_adas(int section) {
    ...
    if (val.type == VALUE_TYPE_NUM) {
        ret = val.val.num;
        CameraLogV("config_get_adas value num:%d", val.val.num);
    }
    return ret;
}
...
int config_get_gsensor(int section) {
    ...
    if (val.type == VALUE_TYPE_NUM) {
        ret = val.val.num;
        CameraLogV("config_get_gsensor value num:%d", val.val.num);
    }
    return ret;
}
...
int config_get_sound(int section) {
    ...
    if (val.type == VALUE_TYPE_NUM) {
        ret = val.val.num;
        CameraLogV("config_get_sound value num:%d", val.val.num);
    }
    return ret;
}
...
int config_set(const char *section, const char *key, char *ibuf) {
    ...
    CameraLogV("val.val.str:%s", val.val.str);
...
int config_get_normalpicidx(int section) {
    ...
    if (val.type == VALUE_TYPE_NUM) {
        ret = val.val.num;
        CameraLogV("config_get_normalpicidx value num:%d", val.val.num);
    }
    return ret;
}
...
int config_get_lockpicidx(int section) {
    ...
    if (val.type == VALUE_TYPE_NUM) {
        ret = val.val.num;
        CameraLogV("config_get_lockpicidx value num:%d", val.val.num);
    }
    return ret;
}
...
int config_get_lockvideoidx(int section) {
    ...
    if (val.type == VALUE_TYPE_NUM) {
        ret = val.val.num;
        CameraLogV("config_get_lockvideoidx value num:%d", val.val.num);
    }
    return ret;
}
...
int config_get_normalpicmax(int section) {
    ...
    if (val.type == VALUE_TYPE_NUM) {
        ret = val.val.num;
        CameraLogV("config_get_maxnormalpicidx value num:%d", val.val.num);
    }
    return ret;
}
...
int config_get_lockpicmax(int section) {
    ...
    if (val.type == VALUE_TYPE_NUM) {
        ret = val.val.num;
        CameraLogV("config_get_maxlockpicidx value num:%d", val.val.num);
    }
    return ret;
}
...
int config_get_normalvideomax(int section) {
    ...
    if (val.type == VALUE_TYPE_NUM) {
        ret = val.val.num;
        CameraLogV("config_get_maxnormalvideoidx value num:%d", val.val.num);
    }
    return ret;
}
...
int config_get_lockvideomax(int section) {
    ...
    if (val.type == VALUE_TYPE_NUM) {
        ret = val.val.num;
        CameraLogV("config_get_maxlockvideoidx value num:%d", val.val.num);
    }
    return ret;
}
...
int config_get_buildid(int section, char *buf) {
    ...
    if (val.type == VALUE_TYPE_STR) {
        ...
        CameraLogV("config_get_build_id value str:%s", val.val.str);
        return 0;
    }
    return -1;
}
...
int config_get_uirgb(int section, char *buf) {
    ...
    if (val.type == VALUE_TYPE_STR) {
        sprintf(buf, "%s", val.val.str);
        CameraLogV("config_get_ui_rgb value str:%s", val.val.str);
        return 0;
    }
    return -1;
}
...
int config_get_uicolor(int section, int *buf) {
    ...
    if (val.type == VALUE_TYPE_NUM) {
        // sprintf(buf, "%s",val.val.str);
        buf[0] = val.val.num;
        CameraLogV("config_get_ui_color red value:%d", val.val.num);
    }
    ...
    if (val.type == VALUE_TYPE_NUM) {
        // sprintf(buf, "%s",val.val.str);
        buf[1] = val.val.num;
        CameraLogV("config_get_ui_color green value:%d", val.val.num);
    }
    ...
    if (val.type == VALUE_TYPE_NUM) {
        // sprintf(buf, "%s",val.val.str);
        buf[2] = val.val.num;
        CameraLogV("config_get_ui_color blue value:%d", val.val.num);
        return 3;
    }
...
int config_get_lcd_auto(int section) {
    ...
    if (val.type == VALUE_TYPE_NUM) {
        ret = val.val.num;
        CameraLogV("config_get_lcd_auto value num:%d", val.val.num);
    }
    return ret;
}
...
int config_get_lcd_brightness(int section) {
    ...
    if (val.type == VALUE_TYPE_NUM) {
        ret = val.val.num;
        CameraLogV("config_get_lcd_brightness value num:%d", val.val.num);
    }
    return ret;
}
...
int config_get_system_volume(int section) {
    ...
    if (val.type == VALUE_TYPE_NUM) {
        ret = val.val.num;
        CameraLogV("config_get_system_volume value num:%d", val.val.num);
    }
    return ret;
}
...
int config_get_system_mute(int section) {
    ...
    if (val.type == VALUE_TYPE_NUM) {
        ret = val.val.num;
        CameraLogV("config_get_system_mute_on value num:%d", val.val.num);
    }
    return ret;
}
...
int config_get_encode_fmt(int section) {
    ...
    if (get_ini_value(sectbuf, CAMERA_ENCODE_FORMAT, &val) == -1) {
        return 0;
    }
    int ret = -1;
    if (val.type == VALUE_TYPE_NUM) {
        ret = val.val.num;
        CameraLogV("value num:%d", val.val.num);
    }
    return ret;
}
...
int config_get_v4l2_fmt(int section) {
    ...
    if (get_ini_value(sectbuf, CAMERA_V4L2_FORMAT, &val) == -1) {
        return 0;
    }
    int ret = -1;
    if (val.type == VALUE_TYPE_NUM) {
...
int config_set_lockvideoidx(int section, int idx) {
    ...
    sprintf(buf, "%d", idx);
    // CameraLogW("config_set_lockvideoidx value %d", idx);
